 ...
 * @since 11/10/15
 */
public interface IsCreateOperation<T> extends FinalCreateUpdateOperation<T> {

    IsValidatedCreateUpdateOperation<T> withValidationCheck(final Predicate<T> validationCheck);
